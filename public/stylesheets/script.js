...
panel.addEventListener('click', event => {
  ...
  replyFormDiv.innerHTML = `
    <form id="modal-reply-form" href="/tweets/${tweet.dataset.tweetid}/replies" action="POST" class="needs-validation" novalidate>
      <textarea class="border border-0 form-control p-0 mb-2" name="tweet" placeholder="推你的回覆" maxlength="141" rows="5" required id="modal-reply-textarea"></textarea>
