...
const additionalUsers = additionalIds.map(id => ({
  ...
  avatar: `https://loremflickr.com/50/50/headshot?lock=${id}`,
  ...
  up: async (queryInterface, Sequelize) => {
    await queryInterface.bulkInsert('Users', [
      ...
      },
      {
        ...
        password: bcrypt.hashSync('12345678', bcrypt.genSaltSync(10), null),
        name: 'Butters',
        avatar: 'https://i.imgur.com/odZDAKG.jpg',
      ...
      },
      {
        ...
        password: bcrypt.hashSync('12345678', bcrypt.genSaltSync(10), null),
        name: 'Eric cartman',
        avatar: 'https://i.imgur.com/0mxrTRc.png',
        cover: 'https://i.imgur.com/n2oDqJ5.jpg',
      ...
      },
      {
        ...
        password: bcrypt.hashSync('12345678', bcrypt.genSaltSync(10), null),
        name: 'Stan',
        avatar: 'https://i.imgur.com/oCEKtzj.jpg',
        cover: '',
