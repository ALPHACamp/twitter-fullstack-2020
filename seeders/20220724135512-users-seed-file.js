      ...
      [
        {
          ...
          name: 'root',
          avatar: `https://minimaltoolkit.com/images/randomdata/female/${Math.floor(Math.random() * 99) + 1}.jpg`,
        ...
        },
        {
          ...
          password: bcrypt.hashSync('12345678', salt),
          name: 'user_one',
          avatar: `https://minimaltoolkit.com/images/randomdata/male/${Math.floor(Math.random() * 99) + 1}.jpg`,
